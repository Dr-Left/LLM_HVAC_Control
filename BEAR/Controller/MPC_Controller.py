...
class MPCAgent(object):
    ...
    def __init__(self, environment, gamma, safety_margin=0.9,
        ...
        self.A_d=environment.A_d + np.random.normal(0, noise, size=environment.A_d.shape)
        self.B_d=environment.B_d + np.random.normal(0, noise, size=environment.B_d.shape)
